...
%default OUTPUT_PATH 's3n://my-output-bucket/$MORTAR_EMAIL_S3_ESCAPED/bacon-bits'

/**
 * User-Defined Functions (UDFs)
 */
REGISTER '../udfs/python/bacon-bits.py' USING streaming_python AS bacon-bits;
...
with_udf_output = FOREACH filtered 
                 GENERATE field0..field2, 
                          bacon-bits.example_udf(field0) AS example_udf_field;
